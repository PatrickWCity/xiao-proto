<template>
  <section class="p-3">
    ...
    <div class="container">
      <button :disabled="readSuccessful" @click="getAllCategorias">
        <span v-if="!readSuccessful">Read now</span>
        <span v-else>Successful!</span>
      </button>
    </div>
    <div class="container">
      <button :disabled="writeSuccessful" @click="createCategoria">
        <span v-if="!writeSuccessful">Write now</span>
        <span v-else>Successful!</span>
      </button>
    </div>
    <div class="container">
      <button :disabled="updateSuccessful" @click="editCategoria">
        <span v-if="!updateSuccessful">Update now</span>
        <span v-else>Successful!</span>
      </button>
    </div>
    <div class="container">
      <button :disabled="deleteSuccessful" @click="deleteCategoria('test')">
    ...
    <div class="container">
      ...
      Getters:
      <p>countCategorias: {{ countCategorias }}</p>
      <p>getCategoriaById: {{ getCategoriaById('test') }}</p>
      <p>getSomeCategoriaById: {{ getSomeCategoriaById('test') }}</p>
      <p>getCategoriaBySlug: {{ getCategoriaBySlug('jh-hh') }}</p>
    </div>
    <div class="py-5">
      <div class="container">
        <div class="row">
          ...
          >
            <div class="card mb-4 box-shadow">
              ...
              />
              <div class="card-body">
                <p class="card-text">Nombre: {{ item.nombre }}</p>
